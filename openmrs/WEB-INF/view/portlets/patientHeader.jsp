...
<table id="patientHeaderObs">
	...
	<tr class="patientObsRow">
		...
		<td id="patientHeaderObsCD4">Gravida:
			<openmrs_tag:mostRecentObs observations="${model.patientObs}"
				concept="5624" locale="${model.locale}" /></td>
		<td id="patientHeaderObsReturnVisit"><spring:message
				code="Patient.returnVisit" />: <openmrs_tag:mostRecentObs
				observations="${model.patientObs}" concept="5624"
				locale="${model.locale}" /></td>
		<td id="patientHeaderObsCD4">Parity:
			<openmrs_tag:mostRecentObs observations="${model.patientObs}"
				concept="1053" locale="${model.locale}" /></td>
		<td id="patientHeaderObsReturnVisit"><spring:message
				code="Patient.returnVisit" />: <openmrs_tag:mostRecentObs
				observations="${model.patientObs}" concept="1053"
				locale="${model.locale}" /></td>
		<td id="patientHeaderObsCD4">SFH:
				<openmrs_tag:mostRecentObs observations="${model.patientObs}"
				concept="6289" locale="${model.locale}" /></td>
		<td id="patientHeaderObsReturnVisit"><spring:message
				code="Patient.returnVisit" />: <openmrs_tag:mostRecentObs
				observations="${model.patientObs}" concept="6289"
				locale="${model.locale}" /></td>
		<td id="patientHeaderObsCD4">Gestation(wks):
				<openmrs_tag:mostRecentObs observations="${model.patientObs}"
				concept="6325" locale="${model.locale}" /></td>
				<td id="patientHeaderObsReturnVisit"><spring:message
				code="Patient.returnVisit" />: <openmrs_tag:mostRecentObs
				observations="${model.patientObs}" concept="6325"
				locale="${model.locale}" /></td>
		<td id="patientHeaderObsCD4">EDD:
				<openmrs_tag:mostRecentObs observations="${model.patientObs}"
				concept="6540" locale="${model.locale}" /></td>
				<td id="patientHeaderObsReturnVisit"><spring:message
				code="Patient.returnVisit" />: <openmrs_tag:mostRecentObs
				observations="${model.patientObs}" concept="6540"
				locale="${model.locale}" /></td>
	</tr>
</table>
